        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
            ...
            <div className="animate-in fade-in slide-in-from-left-8 duration-700">
              <span className="text-brand-amber font-bold uppercase tracking-[0.3em] text-[11px] mb-6 block">Atención Operativa</span>
              ...
              <p className="text-gray-500 mb-14 leading-relaxed font-medium opacity-80 text-lg">
                Si es miembro de un Comité de Vigilancia o Junta Directiva, coordinemos una sesión técnica para presentarle nuestra solvencia operativa detallada.
              </p>
              
              <div className="space-y-10">
                <div className="flex items-center gap-8 group">
                  <div className="w-16 h-16 bg-brand-gray rounded-[18px] flex items-center justify-center text-brand-navy group-hover:bg-brand-amber transition-all duration-520 shadow-sm">
                ...
                <div className="flex items-center gap-8 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 font-medium opacity-80 text-lg">Lunes a Viernes: 9:00 AM - 6:00 PM</p>
                  </div>
                </div>
              </div>

              <div className="mt-20 p-12 bg-brand-navy text-white rounded-[32px] shadow-trust relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/50 text-[15px] mb-8 leading-relaxed font-medium">
                    Para reportes de incidencias o envío de constancias, por favor utilice el canal preferente de atención al residente para una respuesta coordinada.
                  </p>
                  <a href="/atencion-al-residente" className="text-brand-amber font-black text-[11px] uppercase tracking-[0.2em] flex items-center gap-3 hover:text-white transition-all group/link">
            ...
            <div className="animate-in fade-in slide-in-from-right-8 duration-700" style={{ animationDelay: '0.2s' }}>
              <div className="bg-white p-2 md:p-12 border border-[#E1E8F0] shadow-premium rounded-[32px] md:rounded-[40px]">
                <ContactForm />
              </div>
            </div>
          </div>
